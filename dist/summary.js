export function buildSummaryIssue(result) {
    ...
    const mergeCandidates = entries.filter((e) => e.qualityScore >= 8 && e.visionAlignment === "fits");
    ...
    for (const e of entries) {
        ...
        lines.push(`| #${e.prNumber} | ${e.qualityScore} | ${e.visionAlignment} | ${dupeLabel} | ${e.recommendedAction} | ${e.title} |`);
    }
    lines.push(`\n</details>\n`);
    lines.push(`---`);
