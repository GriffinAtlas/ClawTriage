...
import { fetchVisionDoc, checkAlignment } from "./vision.js";

const DUPLICATE_THRESHOLD = 0.9;
const CACHE_MAX_AGE_MS = 60 * 60 * 1000;

export function isCacheStale(cache: EmbeddingCache): boolean {
...
export function findSimilarPRs(
...
const ACTION_DISPLAY: Record<TriageResult["recommendedAction"], { emoji: string; label: string }> = {
...
const VISION_EMOJI: Record<TriageResult["visionAlignment"], string> = {
  fits: "\u2705",
  strays: "\uD83D\uDFE1",
  rejects: "\u274C",
};

export function buildDraftComment(result: Omit<TriageResult, "draftComment">): string {
